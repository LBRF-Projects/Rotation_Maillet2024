...
from mappings import CUSTOM_MAPPINGS, add_controller_mapping
...
def gamepad_init():
    ...
    # Automaticaly add any custom controller mappings
    for guid, name, mapping in CUSTOM_MAPPINGS:
        add_controller_mapping(guid, name, mapping)
